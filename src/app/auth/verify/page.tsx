...
import { Mail, ArrowLeft, Loader2, CheckCircle2, AlertCircle, RefreshCw } from 'lucide-react'
      ...
      <div className="w-full max-w-md">
        ...
        <Card>
          <CardHeader className="text-center">
            ...
            <CardTitle className="text-2xl" suppressHydrationWarning={true}>تحقق من بريدك الإلكتروني</CardTitle>
            <CardDescription suppressHydrationWarning={true}>
              أرسلنا كود تحقق إلى <strong>{email}</strong>
            </CardDescription>
          </CardHeader>
          <CardContent>
            {success ? (
              ...
              <form onSubmit={handleVerify} className="space-y-4">
                ...
                <Alert className="bg-slate-100 border-emerald-700">
                  ...
                  <AlertDescription className="text-emerald-50 text-sm" suppressHydrationWarning={true}>
                    ✅ تم إرسال كود التحقق إلى بريدك الإلكتروني <strong>{email}</strong>
                  </AlertDescription>
                </Alert>
                ...
                <div className="space-y-3">
                  <Alert className="bg-blue-50 border-blue-200">
                    ...
                    <AlertDescription className="text-blue-900 text-sm" suppressHydrationWarning={true}>
                      ...
                      <ul className="list-disc list-inside mt-1 mr-2">
                        <li suppressHydrationWarning={true}>صندوق الوارد (Inbox)</li>
                        <li suppressHydrationWarning={true}>البريد المزعج (Spam)</li>
                        <li suppressHydrationWarning={true}>البريد العشوائي (Junk)</li>
                      </ul>
                    </AlertDescription>
                  </Alert>
                  ...
                  <Alert className="bg-amber-50 border-amber-200">
                    ...
                    <AlertDescription className="text-amber-900 text-sm" suppressHydrationWarning={true}>
                      ⚠️ <strong>وضع التطوير:</strong> يمكنك العثور على الكود في console المتصفح إذا لم يصل إلى بريدك الإلكتروني
                    </AlertDescription>
                  </Alert>
                </div>
              </form>
